...
const modalNavbar = document.querySelector(".head-background");
const closeModalNavbar = document.querySelector(".iconos-head__close-icon");
...
function drawProductInModal() {
    ...
    <div>
        ...
        <p class="truck-modal__price">$125 x <span>$375.00</span></p>
    </div>
...
function cerrarP() {
    const Fomulary= document.querySelector("#formulario");
    const cerrarPBtn = document.querySelector(".iconos-head__close-icon");

    cerrarPBtn.addEventListener("click", () => {
        Fomulary.innerText = "none";
    });
}
